...
<section id="hero" class="hero section dark-background">
      ...
      <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-item active">
          <img src="assets/img/fond1.jpg" alt="">
...
<div class="content">
  <div class="container">
    <div class="row g-0">
      <?php if(isset($alimentations)) { 
        foreach($alimentations as $a) {?> 
      <div class="col-lg-4 col-md-6">
        <div class="service-item">
          <!-- <span class="number"><?=$a['id_alimentation']?></span> -->
          ...
          <div class="service-item-content">
            <h3 class="service-heading"><?=$a['nom_alimentation']?></h3>
            <p> Categorie : <?= $a['nom_categorie'] ?></p>
            <a href="alimentation?action=delete&id_alimentation= <?=$a['id_alimentation'] ?>"><i class="bi bi-trash"></i></a>
            <a href="alimentation?action=update&id_alimentation= <?=$a['id_alimentation'] ?>"><i class="bi bi-pencil"></i></a>
